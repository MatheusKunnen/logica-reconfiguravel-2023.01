...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/aldec/altera_merlin_burst_adapter.sv"                                                    -work burst_adapter                                                           
  vlog  "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                                -work burst_adapter                                                           
