...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/HostSystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/BRAM.vhd"                                                                                -work bram_0                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/qbram.vhd"                                                                               -work bram_0                                                                  
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_bram_0_avalon_slave_0_translator.vhd"                                         -work HostSystem_inst                                                         
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HostSystem_inst                                                         
