...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/HostSystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo -cdslib ./cds_libs/bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.cds.lib
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/BRAM.vhd"                                                                                -work bram_0                                                                   -cdslib ./cds_libs/bram_0.cds.lib                                                                  
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/qbram.vhd"                                                                               -work bram_0                                                                   -cdslib ./cds_libs/bram_0.cds.lib                                                                  
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_bram_0_avalon_slave_0_translator.vhd"                                         -work HostSystem_inst                                                          -cdslib ./cds_libs/HostSystem_inst.cds.lib                                                         
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HostSystem_inst                                                          -cdslib ./cds_libs/HostSystem_inst.cds.lib                                                         
