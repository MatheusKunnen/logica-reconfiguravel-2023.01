...
# ACDS 13.0sp1 232 win32 2023.05.10.22:16:53
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/HostSystem_memory.hex ./
}
...
alias com {
  echo "\[exec\] com"
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_irq_mapper.vho"                                                               -work irq_mapper                                                              
  ...
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_rsp_xbar_mux.vho"                                                             -work rsp_xbar_mux                                                            
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_cmd_xbar_mux.vho"                                                             -work cmd_xbar_mux                                                            
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_cmd_xbar_demux.vho"                                                           -work cmd_xbar_demux                                                          
  ...
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_id_router_001.vho"                                                            -work id_router_001                                                           
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_id_router.vho"                                                                -work id_router                                                               
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_addr_router.vho"                                                              -work addr_router                                                             
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"             -work memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo            
  vlog -sv "$QSYS_SIMDIR/submodules/mentor/altera_merlin_slave_agent.sv"                                                     -work memory_s1_translator_avalon_universal_slave_0_agent                     
  vlog -sv "$QSYS_SIMDIR/submodules/mentor/altera_merlin_burst_uncompressor.sv"                                              -work memory_s1_translator_avalon_universal_slave_0_agent                     
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/mentor/altera_merlin_slave_translator.sv"                                                -work memory_s1_translator                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/mentor/altera_merlin_master_translator.sv"                                               -work cpu_instruction_master_translator                                       
  vcom     "$QSYS_SIMDIR/submodules/BRAM.vhd"                                                                                -work bram_0                                                                  
  vcom     "$QSYS_SIMDIR/submodules/qbram.vhd"                                                                               -work bram_0                                                                  
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_cpu.vhd"                                                                      -work cpu                                                                     
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_cpu_test_bench.vhd"                                                           -work cpu                                                                     
  vcom     "$QSYS_SIMDIR/submodules/HostSystem_memory.vhd"                                                                   -work memory                                                                  
  vcom     "$QSYS_SIMDIR/HostSystem.vhd"                                                                                                                                                                   
  vcom     "$QSYS_SIMDIR/hostsystem_memory_s1_translator.vhd"                                                                                                                                              
  vcom     "$QSYS_SIMDIR/hostsystem_bram_0_avalon_slave_0_translator.vhd"                                                                                                                                  
  vcom     "$QSYS_SIMDIR/hostsystem_memory_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                               
  vcom     "$QSYS_SIMDIR/hostsystem_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"                                                                                                   
  vcom     "$QSYS_SIMDIR/hostsystem_width_adapter.vhd"                                                                                                                                                     
  vcom     "$QSYS_SIMDIR/hostsystem_width_adapter_001.vhd"                                                                                                                                                 
  vcom     "$QSYS_SIMDIR/hostsystem_cpu_instruction_master_translator.vhd"                                                                                                                                 
  vcom     "$QSYS_SIMDIR/hostsystem_cpu_data_master_translator.vhd"                                                                                                                                        
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L width_adapter -L rsp_xbar_mux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L burst_adapter -L id_router_001 -L id_router -L addr_router -L bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo -L memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L memory_s1_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L memory_s1_translator -L cpu_instruction_master_translator -L bram_0 -L cpu -L memory -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
